...
public class TangQuaController {
    ...
    public void themTangQua(TangQuaModel tq) {
        try {
            try ( Connection connection = MysqlConnection.getMysqlConnection()) {
                String query = "INSERT INTO tangqua(idphanqua, mahokhau, hoten, gioitinh, ngaysinh, soluong) "
                        + "VALUES (?,?,?,?,?,?)";
    ...
    public void capNhatTQ(TangQuaModel tq, int id, String maHK, String hoTen) {
        try {
            try ( Connection connection = MysqlConnection.getMysqlConnection()) {
